...
if __name__ == "__main__":
    ...
    parser.add_argument("puzzle", type=int, help="identifier of the puzzle to be solved") # noqa
    parser.add_argument("-n", type=int, default=1, dest="number_of_runs", help="number of runs") # noqa 
